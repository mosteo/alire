      ...
      if not Initialized then
         ...
         Register
            ("crate_bin/alire.toml",
             ...
             GNAT.Calendar.Time_Of (2025, 03, 16, 19, 31, 23, 0.0));
         Register
            ("crate_bin/name.gpr",
         ...
         Register
            ("crate_common/gitignore.hidden",
             ...
             GNAT.Calendar.Time_Of (2025, 03, 16, 20, 00, 40, 0.0));
         Register
         ...
         Register
            ("crate_test/tests/src/name_tests-assertions_enabled."
             ...
             GNAT.Calendar.Time_Of (2025, 03, 16, 19, 39, 57, 0.0));
      end if;
   end Init;
